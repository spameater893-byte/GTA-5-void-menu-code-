...
namespace VoidEngine {
    ...
    public:
        ...
        void Title(const char* title) {
            ...
            // Updated drawing native to match the strict 9-argument function signature
...
void scriptTick() {
    ...
    if (infAmmo) WEAPON::SET_PED_INFINITE_AMMO_CLIP(playerPed, true);
    else WEAPON::SET_PED_INFINITE_AMMO_CLIP(playerPed, false);
